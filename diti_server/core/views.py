...
from .models import OrgGroup, Configuration
from .serializers import UserSerializer, GroupSerializer, OrgGroupSerializer, ConfigurationSerializer
...
class DitiOrgGroupViewSet(viewsets.ModelViewSet):
...
class DitiOrgGroupObjectLevelPermission(DjangoModelPermissions):
    # authenticated_users_only = False
...
class OrgGroupViewSet(DitiOrgGroupViewSet):
