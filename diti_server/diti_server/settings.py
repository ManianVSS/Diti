"""
Django settings for diti_server project.
...
SECRET_KEY = 'django-insecure-59cn950=2hkk7%35bs9_)bxgsd!ec6$j#fl_de^)+_zci8z5@='
...
WSGI_APPLICATION = 'diti_server.wsgi.application'
...
if os.getenv("mode", "staging") == "production":
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DATABASE__NAME', 'diti'),
            'USER': os.getenv('DATABASE__USER', 'ditiadmin'),
            'PASSWORD': os.getenv('DATABASE__PASSWORD', 'ditiadmin@123'),
...
DBBACKUP_STORAGE_OPTIONS = {'location': os.getenv('HOME', '.') + '/backup/Diti/dbbackup'}
# DBBACKUP_CLEANUP_KEEP = 30
# DBBACKUP_CLEANUP_KEEP_MEDIA = 30
# DBBACKUP_HOSTNAME = os.getenv('HOSTNAME', 'localhost')

os.makedirs(os.getenv('HOME', ".") + '/backup/Diti/dbbackup', exist_ok=True, )
